...
class RoleController(BaseController):
    ...
    def delete_user_role(self, user_role_id):
        ...
        if user_role:
            ...
            return self.handle_response(
                "user_role deleted for user", payload={"status": "success"}
            )
        return self.handle_response(
    ...
    def disable_user_role(self):
        ...
        if user_role:
            ...
            self.user_role_repo.update(user_role, **updates)
            return self.handle_response(
                "user_role disabled for user", payload={"status": "success"}
            )
        return self.handle_response(
            "Invalid or incorrect user_role_id provided", status_code=404
        )
    ...
    def get_role_permissions(self, role_id):
        ...
        return self.handle_response(
            "OK", payload={"role_id": role_id, "role_permissions": perm_list}
        )
    ...
    def create_role_permission(self):
        ...
        if not permission:
            ...
            return self.handle_response("This role does not exist", status_code=400)
        return self.handle_response("This permission already exists", status_code=400)
    ...
    def update_permission(self, permission_id):
        ...
        if permission:
            ...
            if name:
                ...
                if permission1:
                    return self.handle_response(
                        "Permission with this name already exists", status_code=400
                    )
                updates["name"] = name
            if role_id:
    ...
    def delete_role_permission(self, permission_id):
        ...
        if permission:
            ...
            self.role_repo.update(permission, **updates)
            return self.handle_response(
                "permission deleted", payload={"status": "success"}
            )
        return self.handle_response(
