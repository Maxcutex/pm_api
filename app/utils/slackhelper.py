...
class SlackHelper:
    ...
    def post_message(self, message, channel, attachments=None, as_user=True):
        ...
        return self.client.chat_postMessage(
            channel=channel, text=message, attachments=attachments, as_user=as_user
        )
    ...
    def update_message(self, message, channel, ts, attachments=None):
        ...
        return self.client.chat_update(
            channel=channel, ts=ts, text=message, attachments=attachments
        )
    ...
    def dialog(self, dialog, trigger_id):
        ...
        """
        return self.client.dialog_open(dialog=dialog, trigger_id=trigger_id)
