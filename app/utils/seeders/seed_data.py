...
role_data = [
    ...
    {"name": "user", "is_active": True, "is_deleted": False},
]
...
user_data = [
    ...
    },
    {
        ...
        "personal_email": "ajebeku@gmail.com",
        "password": generate_password_hash("demo1"),
        "last_password": "",
        "location_id": 1,
        "image_url": "",
...
user_role_data = [
    {"role_id": "1", "user_id": 1, "is_active": True, "is_deleted": False},
    {"role_id": "1", "user_id": 2, "is_active": True, "is_deleted": False},
]
...
permission_data = [
    ...
    },
    {
        ...
        "name": "create_roles",
        "role_id": "1",
        "keyword": "create_roles",
    },
    {
        # "id": "12",
        "name": "delete_roles",
        "role_id": "1",
        "keyword": "delete_roles",
    },
    {
        # "id": "13",
...
user_employment_data = [
    {
        "user_id": 1,
        "institution_name": "The tavia technologies ltd",
        "employment_type": "full",
        "institution_url": "https://www.taviatech.com",
    ...
    {
        "user_id": 1,
        "institution_name": "Citi Investment Capital Ltd",
        "employment_type": "full",
        "institution_url": "http://www.citiinvestmentcapital.com",
        "institution_city": "Lagos",
        "institution_country": "Nigeria",
        "institution_size": "11 - 50 Employees",
        "work_summary": "fake.paragraph(nb_sentences=5)",
    ...
    {
        "user_id": 1,
        "institution_name": "Heritage Banking company Ltd",
        "employment_type": "full",
        "institution_url": "www.hbng.com",
        "institution_city": "Lagos",
        "institution_country": "Nigeria",
        "institution_size": "11 - 50 Employees",
        "work_summary": "fake.paragraph(nb_sentences=5)",
...
user_project_data = [
    {
        "user_id": 1,
        "project_name": "The Tavia Company",
    ...
    {
        "user_id": 1,
        "project_name": "Citi Investment Capital Ltd",
        "project_description": "full",
        "project_url": "fake.uri()",
        "start_date": "2017-12-01",
        "end_date": "2021-06-01",
    ...
    {
        "user_id": 1,
        "project_name": "Heritage Banking Company",
        "project_description": "full",
        "project_url": "fake.uri()",
        "start_date": "2017-12-01",
        "end_date": "2021-06-01",
